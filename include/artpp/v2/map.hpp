...
#include "artpp/v2/cnode.hpp"
#include "artpp/v2/key_codec.hpp"
#include "artpp/v2/tagged_ptr.hpp"
#include "artpp/v2/value_ops.hpp"
     ...
     private:
      ...
      bool insert_(key_param k, VF&& v)
      {
         ...
         if (key.size() > max_key_bytes)  // u16 length fields would silently truncate
            throw std::length_error("artpp::v2::map: encoded key exceeds max_key_bytes (65535)");
...
#undef ARTPP_BODY_BUCKET
         ...
         requires(!inlineable)
      {
         ...
         throw std::out_of_range("artpp::v2::map::at: key not found");
      }
     ...
     public:
      ...
      {
         assert(pos != end() && "artpp::v2::map::erase: pos must be dereferenceable");
...
using detail::map;  // re-export only the public class; impl stays in artpp::v2::detail
